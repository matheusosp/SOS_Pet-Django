...
def set_pet(request):
    ...
    if pet_id:
        ...
        pet= Pet.objects.create(email=email,city=city,phone=phone,description=description,photo=file,user=user)
...
def submit_login(request):
    if request.POST:
        ...
        if user is not None:
            ...
            messages.error(request,'Usuario e senha invalidos, Verifique os Dados e tente novamente')    
    return redirect('/login/')